        ...
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            ...
            <div className="footer__socials">
              <a
                href="https://www.linkedin.com/company/wintegtechnologies/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/share/1BYUc8LesP/"
                target="_blank"
                rel="noopener noreferrer"
                className="footer__social-link"
                aria-label="Facebook"
              ...
              <a
                href="https://www.fiverr.com/s/wkRk1ww"
                target="_blank"
                rel="noopener noreferrer"
                className="footer__social-link"
                aria-label="Fiverr"
              ...
              <a
                href="https://www.instagram.com/wintegtechnologies/"
                target="_blank"
                rel="noopener noreferrer"
                className="footer__social-link"
              ...
              <a
                href="https://www.upwork.com/freelancers/~01d17b4059d10bc6dd"
                target="_blank"
                rel="noopener noreferrer"
                className="footer__social-link"
                aria-label="Upwork"
