...
const milestones = [
  { year: '2022', text: 'Winteg Technologies Founded by Aritra Dutta & Ayon Pal' },
        ...
        <div className="about__grid">
          ...
          <div className="about__content fade-in-right">
            ...
            <p className="about__text">
              ...
              dedicated to helping businesses thrive in the digital world. Founded by Aritra Dutta & Ayon Pal,
