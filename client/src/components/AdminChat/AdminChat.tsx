  ...
  if (!isAuthenticated) {
    return (
      <div className="admin-chat-login">
        <div className="admin-chat-login-wrapper scale-in">
          <div className="admin-chat-login-glow"></div>
          <form onSubmit={connect} className="admin-chat-login-form">
            ...
            <div className="admin-chat-login-header">
              <h2>Winteg Admin</h2>
              <p>Secure Portal for AI Chat & Live Handoffs</p>
            </div>
